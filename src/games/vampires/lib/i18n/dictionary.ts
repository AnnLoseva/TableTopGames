...
export const dictionary: Record<string, string> = {
  ...
  // src/games/vampires/core/vtm5/rules/health/index.ts: getHealthWarning / applyHealthDamage
  ...
  // src/games/vampires/core/vtm5/rules/humanity/index.ts: addHumanityStains warning
  ...
  // src/games/vampires/core/vtm5/rules/disciplines/costs/index.ts, legacy-cost-parser.ts: discipline cost warnings/reasons
