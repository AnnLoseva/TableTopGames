...
-- System VTM rules stay in public/vampires/rules.json + modules/reference — never copied here.
-- Depends on src/games/vampires/supabase/master_console_persistence.sql.
