...
const RU = {
  ...
  topBar: {
    ...
    languageButton: 'EN',
    backToChapter: (number: number) => `К главе ${number}`,
  ...
  loading: {
    ...
    authorOnly: 'Карта отношений — инструмент автора и доступна только после входа.',
    signIn: 'Войти',
    toReader: 'Читать хронику →',
  },
  hint: {
  ...
  characterPanel: {
    ...
    eventEndingsHeading: 'Отношения, которые здесь заканчиваются',
    eventEndingsHint: 'Отмеченные линии пропадут с карты с этой даты — например, когда персонаж умирает.',
    eventEndingsViewLabel: 'Заканчиваются:',
    eventEndAllButton: 'Отметить все',
    eventEndNoneButton: 'Снять все',
    eventNoLinesToEnd: 'У персонажа пока нет линий, которые можно завершить.',
  ...
  relationshipPanel: {
    ...
    eventWhatHappened: 'Что случилось',
    appearanceNoChange: 'Линия: не отмечать',
    appearsOption: 'Здесь линия появляется',
    endsOption: 'Здесь линия заканчивается',
  ...
  timelineControl: {
    ...
    chaptersLabel: 'Главы',
    chapterMarkTitle: (number: number, title: string, date: string) => `Глава ${number} · ${title} · ${date}`,
  ...
  export: {
    ...
    neverEndsWord: 'не заканчивается',
    noEvents: 'нет',
...
const EN: typeof RU = {
  ...
  topBar: {
    ...
    languageButton: 'RU',
    backToChapter: (number: number) => `Back to chapter ${number}`,
  ...
  loading: {
    ...
    authorOnly: 'The relationship map is an author tool — sign in to open it.',
    signIn: 'Sign in',
    toReader: 'Read the chronicle →',
  },
  hint: {
  ...
  characterPanel: {
    ...
    eventEndingsHeading: 'Relationships that end here',
    eventEndingsHint: 'Checked lines leave the map from this date on — when the character dies, say.',
    eventEndingsViewLabel: 'End here:',
    eventEndAllButton: 'Check all',
    eventEndNoneButton: 'Uncheck all',
    eventNoLinesToEnd: 'This character has no lines to end yet.',
  ...
  relationshipPanel: {
    ...
    eventWhatHappened: 'What happened',
    appearanceNoChange: "Line: don't mark",
    appearsOption: 'The line appears here',
    endsOption: 'The line ends here',
  ...
  timelineControl: {
    ...
    chapterMarkTitle: (number: number, title: string, date: string) => `Chapter ${number} · ${title} · ${date}`,
